...
function RunnerAccent({ className = '' }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <circle cx="78" cy="28" r="18" fill="#C8F23A" opacity="0.35" />
      <path
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="overflow-hidden rounded-3xl border border-ink/5 bg-card shadow-sm ring-1 ring-black/5">
          <div className="grid gap-0 lg:grid-cols-2">
            <div className="relative min-h-[280px] bg-gradient-to-br from-stone-200 via-stone-300 to-stone-400 lg:min-h-[420px]">
